...
- Deployment hardening 後的 worktree gate 通過 Portal 61、Config 3、GAS 70、Python 330、Ruff、format、mypy、build、production npm audit 0 與 secret scan；exact commit 後仍須產生 archive checksum 與外部 evidence receipt。
