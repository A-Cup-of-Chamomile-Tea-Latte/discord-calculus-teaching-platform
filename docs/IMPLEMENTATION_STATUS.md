...
| Portal backend | same-origin join／one-case lookup 已在 runtime candidate 實作並通過 17 個安全／failure-mode tests；正式 session provider、durable audit sink、origin 與 rollout 尚未接線，public build 預設仍 fail closed |
