...
網站修改已整理成 `codex/portal-post-v13`，直接基於 post-deploy canonical `f61219b`；既有 checkpoints 為 `5c0472c`、`3f04a69`、`f401a58`、`554669e`，並已加入 GAS dual-scope bridge 修正。原工作樹的其他使用者修改沒有混入整合分支。
